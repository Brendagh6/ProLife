...
function SlidingLogin({ onLogin }) {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            setRegError(error.response?.data?.error || 'Error al registrar. Inténtalo de nuevo.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleSignIn = async (e) => {
        ...
        try {
            ...
            setLoginError(error.response?.data?.error || 'Credenciales incorrectas');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="overlay-container">
                    <div className="overlay">
                        <div className="overlay-panel overlay-left">
                            ...
                            <p>Para mantener conexión con nosotros, inicia sesión con tus datos personales</p>
